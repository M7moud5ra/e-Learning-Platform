...
const adminLogin = asyncHandler(async (req, res) => {
  ...
  const passwordCheck = loggedAdmin.password;
...
const approveStudent = asyncHandler(async (req, res) => {
  ...
  // Document verification email removed - email verification disabled
...
const approveCourse = asyncHandler(async (req, res) => {
  ...
  if (toApprove) {
    ...
    // Email notification removed - email verification disabled
    // const Fname = req.body.Firstname;
    // Course approval email would be sent here
    ...
    // Email notification removed - email verification disabled
    // const Fname = req.body.Firstname;
    // Course rejection email would be sent here
